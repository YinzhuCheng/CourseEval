...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "register.role.administrator.help": "Administrators manage users, runtime images, and platform-wide LLM configurations.",
        "register.teacher_code": "Teacher registration code",
        "register.teacher_code.help": "Required only for teacher accounts.",
        "register.administrator_code": "Administrator registration code",
        "register.administrator_code.help": "Required only for administrator accounts.",
        ...
        "flash.admin_code_required": "Administrator registration code is required for administrator accounts.",
        "flash.admin_code_invalid": "Administrator registration code is incorrect.",
    ...
    "zh": {
        ...
        "register.role.administrator": "管理员",
        "register.role.administrator.help": "管理员负责用户、运行镜像和平台级 LLM 配置管理。",
        "register.teacher_code": "教师注册码",
        "register.teacher_code.help": "仅教师账号注册时需要填写。",
        "register.administrator_code": "管理员注册码",
        "register.administrator_code.help": "仅管理员账号注册时需要填写。",
        ...
        "flash.admin_code_required": "注册管理员账号时必须填写管理员注册码。",
        "flash.admin_code_invalid": "管理员注册码不正确。",
